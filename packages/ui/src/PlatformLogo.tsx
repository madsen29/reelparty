...
export function PlatformLogo({
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Path d={PATHS[platform]} fill={color} />
    </Svg>
  );
}

/** Square colored badge with the platform glyph. */
export function PlatformBadge({
  ...
  return (
    ...
    >
      <PlatformLogo platform={platform} size={Math.round(size * 0.54)} />
    </View>
  );
}

export { INSTAGRAM_GRADIENT };
